...
* Avoided N + 1 queries to the database by fetching the specific model and all necessary associated models in one go
...
* Broke up complicated Backbone views into views focused on one functionality 
